...
public class NgramParser {
    ...
    public static void main(String[] args){
        NgramParser p = new NgramParser("src/shiporder.xml");
...
//        System.out.println(x.toArray()[1]);
    ...
    public HashSet<String> parse(){
        NodeList docnodes = rootElement.getElementsByTagName("book");
        for(int i = 0; i<docnodes.getLength(); i++){
            Element doc = (Element) docnodes.item(i);
            Node text = doc.getElementsByTagName("author").item(0);
